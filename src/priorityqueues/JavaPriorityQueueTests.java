...
public class JavaPriorityQueueTests extends BaseTest {
    ...
    protected <T extends Comparable<T>> AbstractHeapMinPQAssert<T> assertThat(ExtrinsicMinPQ<T> pq) {
        return new JavaPriorityQueueAssert<T>((JavaPriorityQueue<T>) pq);
    }
    ...
    class NewEmpty {
        ...
        void removeMin_throwsNoSuchElement() {
            priorityqueues.ExtrinsicMinPQ<Integer> pq = setUpMinPQ();
    ...
    class EmptyAfterAddRemove extends JavaPriorityQueueTests.NewEmpty {
        @Override
        priorityqueues.ExtrinsicMinPQ<Integer> setUpMinPQ() {
            priorityqueues.ExtrinsicMinPQ<Integer> pq = createMinPQ();
            pq.add(1, 1);
            pq.add(2, 2);
            pq.add(3, 3);
            pq.removeMin();
    ...
    class Add3Decreasing extends JavaPriorityQueueTests.Add3Increasing {
        Add3Decreasing() {
            min = 3;
        }
    ...
    class Add3Arbitrary extends JavaPriorityQueueTests.Add3Increasing {
        Add3Arbitrary() {
            min = 2;
        }
    ...
    class Add10Arbitrary extends JavaPriorityQueueTests.Add10Increasing {
    ...
    class Add10ArbitraryLargeStartingPriorities extends JavaPriorityQueueTests.Add10Arbitrary {
