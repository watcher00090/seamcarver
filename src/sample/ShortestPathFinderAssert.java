...
public class ShortestPathFinderAssert<G extends Graph<V, E>, V, E extends BaseEdge<V, E>>
    extends AbstractObjectAssert<ShortestPathFinderAssert<G, V, E>, ShortestPathFinder<G, V, E>> {

    public ShortestPathFinderAssert(ShortestPathFinder<G, V, E> actual) {
    ...
    public static class ShortestPathAssert<V, E extends BaseEdge<V, E>>
        ...
        public final ShortestPathAssert<V, E> hasVertices(V... vertices) {
            exists();
            // Use Object here since we don't have the exactly type of V
